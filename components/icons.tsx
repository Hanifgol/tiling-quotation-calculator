...
export const HanifgoldLogoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg width="60" height="40" viewBox="0 0 150 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <defs>
            ...
            <linearGradient id="hanifBlue" x1="0" y1="0" x2="1" y2="1">
                <stop offset="0%" stopColor="#2D63C7" />
                <stop offset="100%" stopColor="#1E40AF" />
            </linearGradient>
        </defs>
        <path d="M45 5L5 29.5V70.5L45 95L85 70.5V29.5L45 5Z" fill="url(#hanifBlue)" />
        <path d="M5 29.5L45 50L45 95L5 70.5V29.5Z" stroke="#FFFFFF" strokeOpacity="0.3" strokeWidth="1" />
        <path d="M45 5L45 50L85 29.5L45 5Z" stroke="#FFFFFF" strokeOpacity="0.3" strokeWidth="1" />
        <path d="M45 50L85 70.5L45 95V50Z" stroke="#FFFFFF" strokeOpacity="0.3" strokeWidth="1" />
        <path d="M80 30L110 50L80 70V30Z" fill="url(#hanifGold)" />
    </svg>
);
...
export const BulkGenerateIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const InvoiceIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const ClientsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const PdfIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M10 15h.01" />
    <path d="M10 18h.01" />
    <path d="M16 12h-1.5a1.5 1.5 0 0 0 0 3h1.5" />
    <path d="M16 15h-1.5a1.5 1.5 0 0 0 0 3h1.5" />
    <path d="M12.5 18H10" />
  </svg>
);
...
export const WordIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M8 12.5l2 5 2-5"></path>
        <path d="M12 17.5l2-5 2 5"></path>
    </svg>
);
...
export const CorporateIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const CheckmateIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const WhatsAppIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 1 1-7.6-7.6 8.38 8.38 0 0 1 3.8.9L21 4.5l-4.5 4.5z" />
        <path d="M12.5 16.5a4 4 0 0 0 4-4" />
        <path d="M11 11c0 1 1 2 2 2" />
    </svg>
);
